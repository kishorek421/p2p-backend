  ...
  const renderFormItem = ({ item }: { item: string }) => {
    switch (item) {
      ...
      case "uniqueIdentifierType":
        return (
          <View className="p-4">
            <FormControl isInvalid={isFormFieldInValid("uniqueIdentifierType", errors).length > 0}>
              <FormControlLabel className="mb-1">
              ...
              />
              <FormControlError>
                <FormControlErrorText>{isFormFieldInValid("uniqueIdentifierType", errors)}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "assetType":
        return (
          <View className="p-4">
            <FormControl isInvalid={isFormFieldInValid("asset_Type", errors).length > 0}>
              <FormControlLabel className="mb-1">
              ...
              />
              <FormControlError>
                <FormControlErrorText>{isFormFieldInValid("asset_Type", errors)}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "assetModel":
        return (
          <View className="p-4">
            <FormControl isInvalid={isFormFieldInValid("assetModel", errors).length > 0}>
              <FormControlLabel className="mb-1">
              ...
              />
              <FormControlError>
                <FormControlErrorText>{isFormFieldInValid("assetModel", errors)}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "licensedType":
        return (
          <View className="p-4">
            <FormControl isInvalid={isFormFieldInValid("licensedType", errors).length > 0}>
              <FormControlLabel className="mb-1">
              ...
              />
              <FormControlError>
                <FormControlErrorText>{isFormFieldInValid("licensedType", errors)}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "impact":
        return (
          <View className="p-4">
            <FormControl isInvalid={isFormFieldInValid("impact", errors).length > 0}>
              <FormControlLabel className="mb-1">
              ...
              />
              <FormControlError>
                <FormControlErrorText>{isFormFieldInValid("impact", errors)}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );

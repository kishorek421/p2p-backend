    ...
    >
      <Card className="p-0 rounded-xl">
        <HStack>
          <Image
            source={{
              uri: "https://images.unsplash.com/photo-1483058712412-4245e9b90334?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            }}
            width={130}
            height={220}
          ...
          <View className="flex flex-1 px-4 py-3 gap-5">
            ...
            <View className="flex-row justify-between ">
              ...
              <Text className="">{data.serialNo ?? "-"}</Text>
            </View>
            <View className="flex-row justify-between ">
            ...
            <View className="flex-row justify-between items-center ">
              ...
              <View
                className={`px-4 py-2 rounded-md ${getDeviceStatusColor(data.assetStatusDetails?.key)}`}
              >
                <Text

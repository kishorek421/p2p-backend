...
api.interceptors.request.use(
  async (config) => {
    ...
    const token = "eyJhbGciOiJIUzUxMiJ9..bwffSHIc-y7dcFjSGyzJYxshJfV_Eg-U9pt2LVhE9mWVJkt0aTd7x53GztM4tk8ypFsnK1DtHnzQjGEugKF34w";
    if (token) {

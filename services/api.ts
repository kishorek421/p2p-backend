...
api.interceptors.request.use(
  async (config) => {
    ...
    const token = "eyJhbGciOiJIUzUxMiJ9..UWoqEBgTs65qM23Sc4NZyaKO-LUl0w7nrVveKnySn4nY5IbGk07mghei_clmTkF37xTr7o91q6V_x15Dq6dXvg";
    if (token) {
